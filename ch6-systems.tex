...
Переменная \verb|query| хранит запрос для выборки одной записи. Мы вынесли его
...
Наоборот, ключ \verb|:my-project.queue/task| содержит эту
...
\verb|::db-master|. Компонент \verb|::handler| только читает данные,
