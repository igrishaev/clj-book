...
\item
  Ключи словаря могут быть любыми типами, например строками, числами или датами.

\item
  В \verb|dict| можно передать несколько словарей, и они будут совмещены в
  один. Если предварить словарь синтаксисом \verb|^:opt|, его ключи станут
  необязательными:
