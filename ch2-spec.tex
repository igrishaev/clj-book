...
Теги \code{\circum{}Date} нужны, чтобы компилятор знал тип объектов \code{date1} и
...
\item
  ...
  предварить словарь синтаксисом \code{\circum{}:opt}, его ключи станут необязательными:
