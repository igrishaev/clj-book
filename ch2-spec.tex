...
Фраза \texttt{"" - failed: not-empty in: [:user\zspace{}name]} не только ничего не скажет
...
Заметим, что в векторе нет спеки \texttt{:book/de\zspace{}scription}. Это значит, не
...
\verb|:movie/description|, \texttt{:book/descrip\zspace{}tion} и остальные сходились к
...
(англ.~instru\zspace{}ment~--- <<оснастить, оборудовать>>). Обратите внимание на пространство:
