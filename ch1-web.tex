...
Каждый год компания Cognitect \footurl{опрашивает}{https://blog.cognitect.com/blog/2017/1/31/clojure-2018-results}[Cognitect 2018]
...
Вообразим, что адресу \verb|/| мы бы хотели видеть название сайта, а
...
Теперь посмотрим на форму \clojureinline{(def app ...)} выше. В неё закралась
...
примере одинаковая функция, записанная по-разному.
...
значение истина, клиент уже был на сайте. Это влияет на показ рекламы,
...
переменной \coderef{8}. Например, такой же словарь, но с новым ключом. Вместо
...
Преимущество ресурсов в том, приложение не зависит от сторонних файлов. Это
...
искать ресурсы. Все, что мы говорили о префиксах справедливо и для
...
\footurl{MIME-типов}{https://en.wikipedia.org/wiki/MIME}[MIME types][-5mm]. Добавьте нужные типы и
...
\item
  \footurl{Compojure API}{https://github.com/metosin/compojure-api}[Compo-\\*jure API][-4cm]~---
...
\item
  \footurl{Luminus}{https://luminusweb.net}[Luminus][-3cm]~--- шаблон
...
\item
  \footurl{Pedestal}{https://github.com/pedestal/pedestal}[Pedestal][-2.5cm]~--- фреймворк
...
\item
  \footurl{Vase}{https://github.com/cognitect-labs/vase}[Vase][-1.7cm]~---
...
\item
  \footurl{Duct}{https://github.com/duct-framework/duct}[Duct][-0.6cm]~--- новый
