...
Для Clojure написаны библиотеки \footurl{Sentry-clj}{https://github.com/getsentry/sentry-clj}[Sentry-clj][-12mm] и
\footurl{Exoscale Raven}{https://github.com/exoscale/raven}[Exoscale Raven][10mm]. Первая опирается на
...
Объясним оператор \verb|@| перед вызовом \texttt{r/cap\-tu\-re!} \coderef{7}.
...
Функции из модуля \texttt{ring.util.http\--res\-pon\-se} бывают с восклицательным
